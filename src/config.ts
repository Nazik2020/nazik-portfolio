export const config = {
    developer: {
        ...
        description: "Analytical Computer Science undergraduate focused on Data Science, Machine Learning, and Predictive Analytics. Building end-to-end data pipelines, predictive models, and interactive dashboards."
    },
    social: {
        github: "Nazik2020",
    ...
    projects: [
        ...
        },
        {
            ...
            technologies: "Power BI, DAX, Power Query, Star Schema",
        ...
        {
            id: 4,
            title: "FuelMate - Fuel Expense Tracker",
            category: "Mobile App",
        ...
        },
        {
            ...
            category: "Full Stack",
            technologies: "Django, React, Python, PostgreSQL",
